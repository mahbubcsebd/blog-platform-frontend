...
// সিনট্যাক্স হাইলাইটিং এর জন্য একটি পেশাদার ডার্ক থিম ইম্পোর্ট করুন
import 'highlight.js/styles/atom-one-light.css';

const MarkdownDisplay = ({ content }) => {
  const components = {
    // হেডিং এবং টেক্সট এলিমেন্টের জন্য উন্নত স্টাইলিং
    h1: ({ node, ...props }) => (
      <h1
    ...
    // অ্যাকর্ডিয়নের জন্য নতুন কাস্টম কম্পোনেন্ট যোগ করুন
    ...
    summary: ({ node, ...props }) => (
      // FIXED: <summary> ট্যাগটিকে সরাসরি একটি flex কন্টেইনার বানানো হয়েছে
      <summary
    ...
    // কোড ব্লকের জন্য উন্নত "Mac Terminal" ডিজাইন
